...
public class FullscreenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Intent filter for BitsReceiver, instance of BitsReceiver and register
		IntentFilter mIntentFilter = new IntentFilter(Constants.ACTION_URI);
		BitsReceiver mBitsReceiver = new BitsReceiver() {
			@Override
        ...
        if (!cd.isConnectingToInternet()) {
        	...
        	Toast toast = Toast.makeText(FullscreenActivity.this, "Internet Connection Error", Toast.LENGTH_SHORT);
        	toast.show();
            isInternet = false;
        }
        ...
        if(isInternet) {     	        	
			...
			// TODO: Set a listener, listen the service
